...
export interface ISessions {
   ...
   */
  /**
   * Create a session on the host. Official web goes through
   * `workspaces.startSession`. Product-safe compositions call this with no
   * workspace or cwd when those capabilities are not composed.
